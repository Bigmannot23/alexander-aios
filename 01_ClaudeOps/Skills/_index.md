...
| 4 | claim-audit | AIOS | a factual/perf/legal claim | audited claim | V1 core | Research only | Proposed |
...
Build ~10–12 of these, not 40. 1 of 12 built (route-task) — this repo is at
Block 1 of 7 (see `CURRENT_STATE.md`).
